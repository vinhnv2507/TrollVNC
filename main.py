"""Control IOS entry point.
    ...
    python main.py --scan 172.30.4.0/24  # quét rồi ghi vào config/devices.json
    python main.py --scan-arp            # quét theo bảng ARP (nhanh)
"""
...
from controlios.scan import arp_hosts, probe_hosts, scan_sync


def main() -> int:
    parser = argparse.ArgumentParser(prog="Control IOS")
    parser.add_argument("--scan", nargs="+", metavar="TARGET",
                        help="dải cần quét: 172.30.4.0/24, 172.30.4.10-90, hoặc IP")
